...
// Concrete class for Expression: add case
  public class InfEqExpression extends Expression {
    Expression left;
    Expression right;

    public InfEqExpression(Expression left, Expression right) {
      this.left = left;
      this.right = right;
    }
    ...
    public RetExpression toIR() throws TypeException, UndeclaredSymbolException {
      ...
      Llvm.Instruction eq = new Llvm.InfEq(leftRet.type.toLlvmType(), leftRet.result, rightRet.result, result);
