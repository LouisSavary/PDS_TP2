...
// Concrete class for Expression: add case
  public class SupExpression extends Expression {
    Expression left;
    Expression right;

    public SupExpression(Expression left, Expression right) {
      this.left = left;
      this.right = right;
    }
    ...
    public RetExpression toIR() throws TypeException {
      ...
      Llvm.Instruction eq = new Llvm.Sup(leftRet.type.toLlvmType(), leftRet.result, rightRet.result, result);
